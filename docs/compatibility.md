...
The npm bridge additionally supports opt-in local attachments through `--file-root`. The Python bridge does not currently expose local file paths; use base64 `content` or a public `url` with that bridge.
